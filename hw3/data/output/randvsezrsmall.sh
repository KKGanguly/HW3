...
Considering target file 'act'.
 File 'act' does not exist.
 Looking for an implicit rule for 'act'.
 Trying pattern rule with stem 'act'.
 Trying implicit prerequisite 'act.o'.
 Trying pattern rule with stem 'act'.
 Trying implicit prerequisite 'act.c'.
 Trying pattern rule with stem 'act'.
 Trying implicit prerequisite 'act.cc'.
 Trying pattern rule with stem 'act'.
 Trying implicit prerequisite 'act.C'.
 Trying pattern rule with stem 'act'.
 Trying implicit prerequisite 'act.cpp'.
 Trying pattern rule with stem 'act'.
 Trying implicit prerequisite 'act.p'.
 Trying pattern rule with stem 'act'.
 Trying implicit prerequisite 'act.f'.
 Trying pattern rule with stem 'act'.
 Trying implicit prerequisite 'act.F'.
 Trying pattern rule with stem 'act'.
 Trying implicit prerequisite 'act.m'.
 Trying pattern rule with stem 'act'.
 Trying implicit prerequisite 'act.r'.
 Trying pattern rule with stem 'act'.
 Trying implicit prerequisite 'act.s'.
 Trying pattern rule with stem 'act'.
 Trying implicit prerequisite 'act.S'.
 Trying pattern rule with stem 'act'.
 Trying implicit prerequisite 'act.mod'.
 Trying pattern rule with stem 'act'.
 Trying implicit prerequisite 'act.sh'.
 Trying pattern rule with stem 'act'.
 Trying implicit prerequisite 'act,v'.
 Trying pattern rule with stem 'act'.
 Trying implicit prerequisite 'RCS/act,v'.
 Trying pattern rule with stem 'act'.
 Trying implicit prerequisite 'RCS/act'.
 Trying pattern rule with stem 'act'.
 Trying implicit prerequisite 's.act'.
 Trying pattern rule with stem 'act'.
 Trying implicit prerequisite 'SCCS/s.act'.
 Trying pattern rule with stem 'act'.
 Trying implicit prerequisite 'act.o'.
 Looking for a rule with intermediate file 'act.o'.
  Avoiding implicit rule recursion.
  Trying pattern rule with stem 'act'.
  Trying implicit prerequisite 'act.c'.
  Trying pattern rule with stem 'act'.
  ...
  Trying pattern rule with stem 'act'.
  Trying implicit prerequisite 'act.mod'.
  Trying pattern rule with stem 'act.o'.
  Trying implicit prerequisite 'act.o,v'.
  Trying pattern rule with stem 'act.o'.
  Trying implicit prerequisite 'RCS/act.o,v'.
  Trying pattern rule with stem 'act.o'.
  Trying implicit prerequisite 'RCS/act.o'.
  Trying pattern rule with stem 'act.o'.
  Trying implicit prerequisite 's.act.o'.
  Trying pattern rule with stem 'act.o'.
  Trying implicit prerequisite 'SCCS/s.act.o'.
  Trying pattern rule with stem 'act'.
  Trying implicit prerequisite 'act.c'.
  Looking for a rule with intermediate file 'act.c'.
   Avoiding implicit rule recursion.
   Avoiding implicit rule recursion.
   Trying pattern rule with stem 'act'.
   Trying implicit prerequisite 'act.y'.
   Trying pattern rule with stem 'act'.
   Trying implicit prerequisite 'act.l'.
   Trying pattern rule with stem 'act'.
   Trying implicit prerequisite 'act.w'.
   Trying pattern rule with stem 'act'.
   Trying implicit prerequisite 'act.w'.
   Trying pattern rule with stem 'act.c'.
   Trying implicit prerequisite 'act.c,v'.
   Trying pattern rule with stem 'act.c'.
   Trying implicit prerequisite 'RCS/act.c,v'.
   Trying pattern rule with stem 'act.c'.
   Trying implicit prerequisite 'RCS/act.c'.
   Trying pattern rule with stem 'act.c'.
   Trying implicit prerequisite 's.act.c'.
   Trying pattern rule with stem 'act.c'.
   Trying implicit prerequisite 'SCCS/s.act.c'.
   Trying pattern rule with stem 'act'.
   Trying implicit prerequisite 'act.y'.
   Looking for a rule with intermediate file 'act.y'.
    Avoiding implicit rule recursion.
    Avoiding implicit rule recursion.
    Avoiding implicit rule recursion.
    Trying pattern rule with stem 'act.y'.
    Trying implicit prerequisite 'act.y,v'.
    Trying pattern rule with stem 'act.y'.
    Trying implicit prerequisite 'RCS/act.y,v'.
    Trying pattern rule with stem 'act.y'.
    Trying implicit prerequisite 'RCS/act.y'.
    Trying pattern rule with stem 'act.y'.
    Trying implicit prerequisite 's.act.y'.
    Trying pattern rule with stem 'act.y'.
    Trying implicit prerequisite 'SCCS/s.act.y'.
   Trying pattern rule with stem 'act'.
   Trying implicit prerequisite 'act.l'.
   Looking for a rule with intermediate file 'act.l'.
    Avoiding implicit rule recursion.
    Avoiding implicit rule recursion.
    Avoiding implicit rule recursion.
    Trying pattern rule with stem 'act.l'.
    Trying implicit prerequisite 'act.l,v'.
    Trying pattern rule with stem 'act.l'.
    Trying implicit prerequisite 'RCS/act.l,v'.
    Trying pattern rule with stem 'act.l'.
    Trying implicit prerequisite 'RCS/act.l'.
    Trying pattern rule with stem 'act.l'.
    Trying implicit prerequisite 's.act.l'.
    Trying pattern rule with stem 'act.l'.
    Trying implicit prerequisite 'SCCS/s.act.l'.
   Trying pattern rule with stem 'act'.
   Trying implicit prerequisite 'act.w'.
   Looking for a rule with intermediate file 'act.w'.
    Avoiding implicit rule recursion.
    Avoiding implicit rule recursion.
    Avoiding implicit rule recursion.
    Trying pattern rule with stem 'act.w'.
    Trying implicit prerequisite 'act.w,v'.
    Trying pattern rule with stem 'act.w'.
    Trying implicit prerequisite 'RCS/act.w,v'.
    Trying pattern rule with stem 'act.w'.
    Trying implicit prerequisite 'RCS/act.w'.
    Trying pattern rule with stem 'act.w'.
    Trying implicit prerequisite 's.act.w'.
    Trying pattern rule with stem 'act.w'.
    Trying implicit prerequisite 'SCCS/s.act.w'.
   Trying pattern rule with stem 'act'.
   Rejecting impossible implicit prerequisite 'act.w'.
  Trying pattern rule with stem 'act'.
  Trying implicit prerequisite 'act.cc'.
  Looking for a rule with intermediate file 'act.cc'.
   Avoiding implicit rule recursion.
   Avoiding implicit rule recursion.
   Trying pattern rule with stem 'act.cc'.
   Trying implicit prerequisite 'act.cc,v'.
   Trying pattern rule with stem 'act.cc'.
   Trying implicit prerequisite 'RCS/act.cc,v'.
   Trying pattern rule with stem 'act.cc'.
   Trying implicit prerequisite 'RCS/act.cc'.
   Trying pattern rule with stem 'act.cc'.
   Trying implicit prerequisite 's.act.cc'.
   Trying pattern rule with stem 'act.cc'.
   Trying implicit prerequisite 'SCCS/s.act.cc'.
  Trying pattern rule with stem 'act'.
  Trying implicit prerequisite 'act.C'.
  Looking for a rule with intermediate file 'act.C'.
   Avoiding implicit rule recursion.
  ...
  Trying pattern rule with stem 'act'.
  Trying implicit prerequisite 'act.cpp'.
  Looking for a rule with intermediate file 'act.cpp'.
   Avoiding implicit rule recursion.
   Avoiding implicit rule recursion.
   Trying pattern rule with stem 'act.cpp'.
   Trying implicit prerequisite 'act.cpp,v'.
   Trying pattern rule with stem 'act.cpp'.
   Trying implicit prerequisite 'RCS/act.cpp,v'.
   Trying pattern rule with stem 'act.cpp'.
   Trying implicit prerequisite 'RCS/act.cpp'.
   Trying pattern rule with stem 'act.cpp'.
   Trying implicit prerequisite 's.act.cpp'.
   Trying pattern rule with stem 'act.cpp'.
   Trying implicit prerequisite 'SCCS/s.act.cpp'.
  Trying pattern rule with stem 'act'.
  Trying implicit prerequisite 'act.p'.
  Looking for a rule with intermediate file 'act.p'.
   Avoiding implicit rule recursion.
   Avoiding implicit rule recursion.
   Trying pattern rule with stem 'act'.
   Trying implicit prerequisite 'act.web'.
   Trying pattern rule with stem 'act.p'.
   Trying implicit prerequisite 'act.p,v'.
   Trying pattern rule with stem 'act.p'.
   Trying implicit prerequisite 'RCS/act.p,v'.
   Trying pattern rule with stem 'act.p'.
   Trying implicit prerequisite 'RCS/act.p'.
   Trying pattern rule with stem 'act.p'.
   Trying implicit prerequisite 's.act.p'.
   Trying pattern rule with stem 'act.p'.
   Trying implicit prerequisite 'SCCS/s.act.p'.
   Trying pattern rule with stem 'act'.
   Trying implicit prerequisite 'act.web'.
   Looking for a rule with intermediate file 'act.web'.
    Avoiding implicit rule recursion.
    Avoiding implicit rule recursion.
    Avoiding implicit rule recursion.
    Trying pattern rule with stem 'act.web'.
    Trying implicit prerequisite 'act.web,v'.
    Trying pattern rule with stem 'act.web'.
    Trying implicit prerequisite 'RCS/act.web,v'.
    Trying pattern rule with stem 'act.web'.
    Trying implicit prerequisite 'RCS/act.web'.
    Trying pattern rule with stem 'act.web'.
    Trying implicit prerequisite 's.act.web'.
    Trying pattern rule with stem 'act.web'.
    Trying implicit prerequisite 'SCCS/s.act.web'.
  Trying pattern rule with stem 'act'.
  Trying implicit prerequisite 'act.f'.
  Looking for a rule with intermediate file 'act.f'.
   Avoiding implicit rule recursion.
   Avoiding implicit rule recursion.
   Trying pattern rule with stem 'act'.
   Trying implicit prerequisite 'act.F'.
   Trying pattern rule with stem 'act'.
   Trying implicit prerequisite 'act.r'.
   Trying pattern rule with stem 'act.f'.
   Trying implicit prerequisite 'act.f,v'.
   Trying pattern rule with stem 'act.f'.
   Trying implicit prerequisite 'RCS/act.f,v'.
   Trying pattern rule with stem 'act.f'.
   Trying implicit prerequisite 'RCS/act.f'.
   Trying pattern rule with stem 'act.f'.
   Trying implicit prerequisite 's.act.f'.
   Trying pattern rule with stem 'act.f'.
   Trying implicit prerequisite 'SCCS/s.act.f'.
   Trying pattern rule with stem 'act'.
   Trying implicit prerequisite 'act.F'.
   Looking for a rule with intermediate file 'act.F'.
    Avoiding implicit rule recursion.
   ...
   Trying pattern rule with stem 'act'.
   Trying implicit prerequisite 'act.r'.
   Looking for a rule with intermediate file 'act.r'.
    Avoiding implicit rule recursion.
    Avoiding implicit rule recursion.
    Avoiding implicit rule recursion.
    Trying pattern rule with stem 'act'.
    Rejecting impossible implicit prerequisite 'act.l'.
    Trying pattern rule with stem 'act.r'.
    Trying implicit prerequisite 'act.r,v'.
    Trying pattern rule with stem 'act.r'.
    Trying implicit prerequisite 'RCS/act.r,v'.
    Trying pattern rule with stem 'act.r'.
    Trying implicit prerequisite 'RCS/act.r'.
    Trying pattern rule with stem 'act.r'.
    Trying implicit prerequisite 's.act.r'.
    Trying pattern rule with stem 'act.r'.
    Trying implicit prerequisite 'SCCS/s.act.r'.
  Trying pattern rule with stem 'act'.
  Rejecting impossible implicit prerequisite 'act.F'.
  Trying pattern rule with stem 'act'.
  Trying implicit prerequisite 'act.m'.
  Looking for a rule with intermediate file 'act.m'.
   Avoiding implicit rule recursion.
   Avoiding implicit rule recursion.
   Trying pattern rule with stem 'act'.
   Trying implicit prerequisite 'act.ym'.
   Trying pattern rule with stem 'act.m'.
   Trying implicit prerequisite 'act.m,v'.
   Trying pattern rule with stem 'act.m'.
   Trying implicit prerequisite 'RCS/act.m,v'.
   Trying pattern rule with stem 'act.m'.
   Trying implicit prerequisite 'RCS/act.m'.
   Trying pattern rule with stem 'act.m'.
   Trying implicit prerequisite 's.act.m'.
   Trying pattern rule with stem 'act.m'.
   Trying implicit prerequisite 'SCCS/s.act.m'.
   Trying pattern rule with stem 'act'.
   Trying implicit prerequisite 'act.ym'.
   Looking for a rule with intermediate file 'act.ym'.
    Avoiding implicit rule recursion.
    Avoiding implicit rule recursion.
    Avoiding implicit rule recursion.
    Trying pattern rule with stem 'act.ym'.
    Trying implicit prerequisite 'act.ym,v'.
    Trying pattern rule with stem 'act.ym'.
    Trying implicit prerequisite 'RCS/act.ym,v'.
    Trying pattern rule with stem 'act.ym'.
    Trying implicit prerequisite 'RCS/act.ym'.
    Trying pattern rule with stem 'act.ym'.
    Trying implicit prerequisite 's.act.ym'.
    Trying pattern rule with stem 'act.ym'.
    Trying implicit prerequisite 'SCCS/s.act.ym'.
  Trying pattern rule with stem 'act'.
  Rejecting impossible implicit prerequisite 'act.r'.
  Trying pattern rule with stem 'act'.
  Trying implicit prerequisite 'act.s'.
  Looking for a rule with intermediate file 'act.s'.
   Avoiding implicit rule recursion.
   Avoiding implicit rule recursion.
   Trying pattern rule with stem 'act'.
   Trying implicit prerequisite 'act.S'.
   Trying pattern rule with stem 'act.s'.
   Trying implicit prerequisite 'act.s,v'.
   Trying pattern rule with stem 'act.s'.
   Trying implicit prerequisite 'RCS/act.s,v'.
   Trying pattern rule with stem 'act.s'.
   Trying implicit prerequisite 'RCS/act.s'.
   Trying pattern rule with stem 'act.s'.
   Trying implicit prerequisite 's.act.s'.
   Trying pattern rule with stem 'act.s'.
   Trying implicit prerequisite 'SCCS/s.act.s'.
   Trying pattern rule with stem 'act'.
   Trying implicit prerequisite 'act.S'.
   Looking for a rule with intermediate file 'act.S'.
    Avoiding implicit rule recursion.
    ...
    Trying implicit prerequisite 'SCCS/s.act.S'.
  Trying pattern rule with stem 'act'.
  Rejecting impossible implicit prerequisite 'act.S'.
  Trying pattern rule with stem 'act'.
  Trying implicit prerequisite 'act.mod'.
  Looking for a rule with intermediate file 'act.mod'.
   Avoiding implicit rule recursion.
   Avoiding implicit rule recursion.
   Trying pattern rule with stem 'act.mod'.
   Trying implicit prerequisite 'act.mod,v'.
   Trying pattern rule with stem 'act.mod'.
   Trying implicit prerequisite 'RCS/act.mod,v'.
   Trying pattern rule with stem 'act.mod'.
   Trying implicit prerequisite 'RCS/act.mod'.
   Trying pattern rule with stem 'act.mod'.
   Trying implicit prerequisite 's.act.mod'.
   Trying pattern rule with stem 'act.mod'.
   Trying implicit prerequisite 'SCCS/s.act.mod'.
 Trying pattern rule with stem 'act'.
 Rejecting impossible implicit prerequisite 'act.c'.
 Trying pattern rule with stem 'act'.
 Rejecting impossible implicit prerequisite 'act.cc'.
 Trying pattern rule with stem 'act'.
 Rejecting impossible implicit prerequisite 'act.C'.
 Trying pattern rule with stem 'act'.
 Rejecting impossible implicit prerequisite 'act.cpp'.
 Trying pattern rule with stem 'act'.
 Rejecting impossible implicit prerequisite 'act.p'.
 Trying pattern rule with stem 'act'.
 Rejecting impossible implicit prerequisite 'act.f'.
 Trying pattern rule with stem 'act'.
 Rejecting impossible implicit prerequisite 'act.F'.
 Trying pattern rule with stem 'act'.
 Rejecting impossible implicit prerequisite 'act.m'.
 Trying pattern rule with stem 'act'.
 Rejecting impossible implicit prerequisite 'act.r'.
 Trying pattern rule with stem 'act'.
 Rejecting impossible implicit prerequisite 'act.s'.
 ...
 Rejecting impossible implicit prerequisite 'act.S'.
 Trying pattern rule with stem 'act'.
 Rejecting impossible implicit prerequisite 'act.mod'.
 Trying pattern rule with stem 'act'.
 Trying implicit prerequisite 'act.sh'.
 Looking for a rule with intermediate file 'act.sh'.
  Avoiding implicit rule recursion.
  Trying pattern rule with stem 'act.sh'.
  Trying implicit prerequisite 'act.sh,v'.
  Trying pattern rule with stem 'act.sh'.
  Trying implicit prerequisite 'RCS/act.sh,v'.
  Trying pattern rule with stem 'act.sh'.
  Trying implicit prerequisite 'RCS/act.sh'.
  Trying pattern rule with stem 'act.sh'.
  Trying implicit prerequisite 's.act.sh'.
  Trying pattern rule with stem 'act.sh'.
  Trying implicit prerequisite 'SCCS/s.act.sh'.
 No implicit rule found for 'act'.
 Finished prerequisites of target file 'act'.
Must remake target 'act'.
